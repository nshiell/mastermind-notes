...
namespace NShiell\MastermindNotes\DAVACL\PrincipalBackend;
...
*/
    ...
    function updatePrincipal($path, DAV\PropPatch $propPatch) {
        trigger_error('updatePrincipal not impleneted');
...
return [];
    ...
    function setGroupMemberSet($principal, array $members) {
        trigger_error('setGroupMemberSet not imenented');
    ...
    function createPrincipal($path, MkCol $mkCol) {
        trigger_error('createPrincipal not imenented');
